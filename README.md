...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyrender-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14622&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyrender-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyrender` can be installed with:

```
conda install pyrender
```

It is possible to list all of the versions of `pyrender` available on your platform with:
